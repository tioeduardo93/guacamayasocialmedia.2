import { Box, chakra, Container, Flex, Grid, Icon, Image, useColorModeValue } from '@chakra-ui/react';
      ...
      >
        ...
        <div>
          ...
          <Box py={4} px={6}>
            ...
            <chakra.p fontSize={'sm'} py={2} color={useColorModeValue("gray.700", "gray.400")}>
              {description}
            </chakra.p>
          </Box>
        </div>
...
export default function AboutUsPage() {
  return (
    <MainLayout>
      ...
      <Grid mb={12} gap="1rem" templateColumns={{
        base: '1fr',
        lg: '1fr 1fr'
      }}>
        <Card
          ...
          description={'Athina is a fan of Harry Potter, kiss and hamburgers, studied journalism and has a great experience in content production and advertising but her greatest skill is that she is an amazing video editor.'}
        />
        <Card
