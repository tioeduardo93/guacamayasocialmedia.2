...
import { Box, Button, Container, chakra, Input, Text } from '@chakra-ui/react'
  ...
  <Box as="section" bg="bg-surface">
    ...
    >
      ...
      <chakra.form display="flex" onSubmit={handleSubmit}>
        <Input value={value} onChange={(e)=>setValue(e.target.value)} type="email" pr="2rem" placeholder="email@example.com" bg="white" />
        <Button ml={'-2rem'} px={8} colorScheme={'brand'} rounded="full">Get on board</Button>
      </chakra.form>
    </Container>
  </Box>
  )
